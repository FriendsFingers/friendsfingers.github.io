<template>
    <section class="content">
        <div class="container">
            ...
            <div class="card mb-3">
                <div class="card-header">{{ $site.name }} Privacy and Cookie Policy</div>
                <div class="card-body">
            ...
            <div class="alert alert-primary mb-3" role="alert">
                <p>Note</p>
                <small>Data collected on Ethereum blockchain are public for its own nature. So any data stored in Ethereum blockchain may be accessible through other applications or exploring the blockchain itself.</small>
            </div>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <p>The Data concerning the User is collected to allow the Owner to provide its Services, as well as for the following purposes: Analytics, Content commenting, Managing contacts and sending messages and Interaction with live chat platforms.</p>
                ...
                <div class="card-body">
                    ...
                    <ul>
                        <li>
                            ...
                            <p>Place of processing: US – <a href="https://www.google.com/intl/en/policies/privacy/" target="_blank">Privacy Policy</a></p>
                        </li>
                        <li>
                            ...
                            <p>Place of processing: US – <a href="https://www.facebook.com/about/privacy/" target="_blank">Privacy Policy</a></p>
                        </li>
                        <li>
                            ...
                            <p>CloudFlare is a traffic optimization and distribution service provided by CloudFlare Inc.<br>
                                ...
                                Personal Data collected: Cookies and various types of Data as specified in the privacy policy of the service.</p>
                            <p>Place of processing: US – <a href="https://www.cloudflare.com/security-policy/" target="_blank">Privacy Policy</a></p>
                        </li>
                        <li>
                            <b>Disqus (Disqus)</b>
                            ...
                            <p>Place of processing: US – <a href="https://help.disqus.com/customer/portal/articles/466259-privacy-policy" target="_blank">Privacy Policy</a></p>
                        </li>
                        <li>
                            ...
                            <p>The Drift Widget is a service for interacting with the Drift live chat platform provided by Drift.com, Inc.<br>
                                Personal Data collected: Cookies, Usage Data and various types of Data as specified in the privacy policy of the service.</p>
                            <p>Place of processing: US – <a href="https://www.drift.com/privacy-policy/" target="_blank">Privacy Policy</a></p>
                        </li>
                        <li>
                            ...
                            <p>Place of processing: US – <a href="https://mailchimp.com/legal/privacy/" target="_blank">Privacy Policy</a></p>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
