            ...
            <b-col lg="12">
                <h1 class="display-5">
                    <b-img :src="$withBase('/assets/images/logo/friendsfingers.svg')"
                           ...
                           :alt="$site.title"/>
                    <br>
                    FriendsFingers Privacy and Cookie Policy
                </h1>
            </b-col>
        </b-row>
        <b-row>
            <b-col lg="12">
                <b-card class="mb-3">
                    <b-card-text>
                        ...
                        <p>FriendsFingers.com</p>
                        <p>Owner contact email: support@friendsfingers.com</p>
                    </b-card-text>
                </b-card>

                <b-alert show variant="primary" class="mb-3">
                    <h4 class="alert-heading">Note</h4>
                    <p>
                        Data collected on Ethereum blockchain are public for its own nature. So any data stored in
                        Ethereum blockchain may be accessible through other applications or exploring the blockchain
                        itself.
                    </p>
                </b-alert>

                <b-card title="Types of Data collected" class="mb-3">
                    <b-card-text>
                        <p>
                            Among the types of Personal Data that this Application collects, by itself or through third
                            parties, there are: Cookies, Usage Data and email address.
                        </p>
                        <p>
                ...
                <b-card title="Mode and place of processing the Data" class="mb-3">
                    <b-card-text>
                ...
                <b-card title="The purposes of processing" class="mb-3">
                    <b-card-text>
                        <p>
                            The Data concerning the User is collected to allow the Owner to provide its Services, as
                            well as for the following purposes: Analytics, Content commenting, Managing contacts and
                            sending messages and Interaction with live chat platforms.
                        </p>
                        <p>
                ...
                <b-card title="Detailed information on the processing of Personal Data" class="mb-3">
                    <b-card-text>
                        ...
                        <ul>
                            <li>
                                ...
                                <p>
                                    ...
                                    <b-link href="https://www.google.com/intl/en/policies/privacy/" target="_blank">
                                        Privacy Policy
                                    </b-link>
                                </p>
                            </li>
                            <li>
                                ...
                                <p>
                                    CloudFlare is a traffic optimization and distribution service provided by CloudFlare
                                    Inc.<br>
                                    The way CloudFlare is integrated means that it filters all the traffic through this
                                    Application, i.e., communication between this Application and the User's browser,
                                    while also allowing analytical data from this Application to be collected.<br>
                                    Personal Data collected: Cookies and various types of Data as specified in the
                                    privacy policy of the service.
                                </p>
                                <p>
                                    Place of processing: US –
                                    <b-link href="https://www.cloudflare.com/security-policy/" target="_blank">Privacy
                                        Policy
                                    </b-link>
                                </p>
                            </li>
                ...
                <b-card title="The rights of Users" class="mb-3">
                    <b-card-text>
                        ...
                        <ul>
                            ...
                            <li>
                                <b>Access their Data.</b> Users have the right to learn if Data is being processed by
                            ...
                            <li>
                                <b>Receive their Data and have it transferred to another controller.</b> Users have the
                            ...
                            <li>
                                <b>Lodge a complaint.</b> Users have the right to bring a claim before their competent
                ...
                <b-card title="Additional information about Data collection and processing" class="mb-3">
                    <b-card-text>
                        <h4>Legal action</h4>
                        <p>
                        ...
                        <p>
                            This Application does not support “Do Not Track” requests.<br>To determine whether any of
                        ...
                        <p>
                            ...
                            the date of the last modification listed at the bottom. <br><br>Should the changes affect
                            processing activities performed on the basis of the User’s consent, the Owner shall collect
                ...
                <b-card class="mb-3">
                    <b-card-text>
                        ...
                        <p>
                            ...
                            employed in this Application), which can include: the IP addresses or domain names of the
                            computers utilized by the Users who use this Application, the URI addresses (Uniform
                            Resource Identifier), the time of the request, the method utilized to submit the request to
                            the server, the size of the file received in response, the numerical code indicating the
                            status of the server's answer (successful outcome, error, etc.), the country of origin, the
                            features of the browser and the operating system utilized by the User, the various time
                            details per visit (e.g., the time spent on each page within the Application) and the details
                            about the path followed within the Application with special reference to the sequence of
                        ...
                        <p>
                            The natural or legal person, public authority, agency or other body which processes Personal
                        ...
                        <p>
                            ...
                            the security measures concerning the operation and use of this Application. The Data
                        ...
                        <h4>Service</h4>
                        <p>
                            The service provided by this Application as described in the relative terms (if available)
